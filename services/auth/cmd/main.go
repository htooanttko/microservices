...
import (
	...
	"github.com/htooanttko/microservices/services/auth/internal/config"
	"github.com/htooanttko/microservices/services/auth/internal/handlers"
...
func main() {
	...
	authRepo := repositories.NewAuthRepository(psql)
